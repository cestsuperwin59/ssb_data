### 14165: Arrivals, by type of accommodation and guests' country of residence (C) 2016M01 - 2024M05
import requests
import pandas as pd
import json
import io
...
def get_user_input():
    table_number = input("Enter the table number (e.g., 14165): ")
...
try:
    ...
    csv_file_path = 'tourist_numbers.csv'
